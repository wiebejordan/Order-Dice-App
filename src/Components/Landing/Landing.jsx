    ...
    <div>
      <Container textAlign='center' >
        ...
        <p style={{fontSize: '10px'}}>
          *Order Dice and the games mentioned above are owned by <a href='https://store.warlordgames.com/'>Warlord Games</a>. To have the best experience with their games, make sure you purchase physical order dice to place next to your units after they activate.  
        </p>
        </Segment>
      </Container>
