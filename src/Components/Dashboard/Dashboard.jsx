...
class Dashboard extends Component {
    ...
    if (this.state.drawDice === false) {
      ...
      if (this.state.whoUndo === "playerOne" && this.state.dotLast === false) {
        ...
        diceBag.splice(
          ...
          0,
          this.props.playerTwo.diceColor
        );
      } else if (
        ...
        diceBag.splice(
          ...
          0,
          this.props.playerThree.diceColor
        );
      } else if (
        ...
        diceBag.splice(
          ...
          0,
          this.props.playerFour.diceColor
        );
      }
  ...
  handleDiceDraw = (props) => {
    ...
    if (
      this.state.diceBag.length === this.state.totalDice - 1 &&
  ...
  handleRemoveP3Dice = (props) => {
    ...
    if (this.state.playerThreeRemainingDice > 0) {
      diceBag.splice(
        [this.state.playerOneRemainingDice + this.state.playerTwoRemainingDice],
        1
      );
      this.setState({
        playerThreeRemainingDice: this.state.playerThreeRemainingDice - 1,
  ...
  handleFrenchDice = () => {
    ...
    if (pulledDice == this.props.playerOne.diceColor) {
      ...
      diceBag.splice(
        [playerOneRemainingDice + playerTwoRemainingDice],
        0,
        this.props.playerTwo.diceColor
      );
      ...
      <div style={{ height: "100%" }}>
        ...
        <div className="dice-container">
          {!this.state.pulledDice ? (
            <b style={{ fontSize: "15px", marginLeft: "100px" }}>
        ...
        {this.props.playerCount > 2 ? (
          <h2 style={{ marginTop: 0, color: "white" }}>
            Total dice in bag: {this.state.diceBag.length}
          </h2>
        ) : null}
        ...
        <Modal
          size="tiny"
          dimmer="inverted"
          open={this.state.firstDice === true}
        >
          <Modal.Content centered>
            <Header centered>Communication Breakdown! </Header>
            <p>
              The first order dice of the game is{" "}
              <b
                style={{ color: `${this.state.pulledDice}`, fontSize: "20px" }}
              >
                {this.state.pulledDice}
              </b>
              .
            ...
            <p>
              Does this order dice belong to a French army, or any army with the
              Communication Breakdown rule?
            </p>
            <p>If no, simply click the "leave dice in play" button</p>
            <p>
              If yes, the opponent may decide to return this order dice to the
              bag, or leave it in play.
            </p>
